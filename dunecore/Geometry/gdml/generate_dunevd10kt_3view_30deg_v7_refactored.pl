...
#                 and the cathode.
#    v7:    Jul 2024: Viktor Pec (viktor.pec@fzu.cz)
#           Purpose: realistic modeling of the CRPs - dimensions and positions within the anode plane.
#
#################################################################################
...
# create a smaller geometry with both drift volumes (2x8x6)
if( $workspace == 6 )
{
    $nCRM_y = 4 * 2;
    $nCRM_z = 3 * 2;
